...
def run_test():
    """执行测试"""
    print("=" * 70)
    print("AI NPC Roleplay Prompt Test v2")
    print("=" * 70)
    ...
    for i in range(TEST_ROUNDS):
        ...
        # Update history (keep last 3 rounds)
        if history:
            history += "\n"
    ...
    print(f"Total Rounds: {TEST_ROUNDS}")
